...
- v24 gives buildings authoritative partial navigation footprints. The Core blocks a 3×3 core, Barracks/Workshop block a five-cell cross, and smaller structures block their center cell. Foundations block from construction start, destroyed resource structures release navigation, and trained units appear outside the producer footprint. Visual overhang beyond the core footprint remains traversable.
