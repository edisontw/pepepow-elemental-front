...
describe('post-roadmap replay v5 identity', () => {
  it('binds replay state to starting Attunements and ef-standard-v5', () => {
    ...
    expect(packet.header.version).toBe('ef-replay-v5');
