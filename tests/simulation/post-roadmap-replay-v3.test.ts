...
describe('post-roadmap replay v4 identity', () => {
  it('binds replay state to starting Attunements and ef-standard-v4', () => {
    ...
    expect(packet.header.version).toBe('ef-replay-v4');
