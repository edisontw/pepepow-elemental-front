...
describe('post-roadmap replay v7 identity', () => {
  it('binds replay state to starting Attunements and ef-standard-v9', () => {
    ...
    expect(packet.header.version).toBe('ef-replay-v9');
