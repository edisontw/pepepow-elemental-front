...
describe('post-roadmap replay v6 identity', () => {
  it('binds replay state to starting Attunements and ef-standard-v6', () => {
    ...
    expect(packet.header.version).toBe('ef-replay-v6');
