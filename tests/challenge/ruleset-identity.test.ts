...
describe('post-roadmap competitive ruleset identity', () => {
  it('versions ef-standard-v26 gameplay independently from the stable M02 world generator', () => {
    ...
    expect(CURRENT_CHALLENGE_RULESET_VERSION).toBe('ef-standard-v26');
    ...
    expect(replay.header.version).toBe('ef-replay-v26');
