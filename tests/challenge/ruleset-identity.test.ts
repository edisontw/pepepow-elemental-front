...
describe('post-roadmap competitive ruleset identity', () => {
  it('versions ef-standard-v19 gameplay independently from the stable M02 world generator', () => {
    ...
    expect(CURRENT_CHALLENGE_RULESET_VERSION).toBe('ef-standard-v19');
    ...
    expect(replay.header.version).toBe('ef-replay-v19');
