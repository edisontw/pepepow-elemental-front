...
export const UNITS: Readonly<Record<UnitArchetype, UnitDefinition>> = {
  VANGUARD: {
    ...
    spawn: { speedPerTick: 360, selectionRadius, bodyRadius: 480, maxHealth: 180, attackDamage: 18, attackIntervalTicks: 11, attackRange: 1.25 * M },
  },
  SPEAR_GUARD: {
    ...
    spawn: { speedPerTick: 310, selectionRadius, bodyRadius: 480, maxHealth: 220, attackDamage: 20, attackIntervalTicks: 14, attackRange: 2.2 * M },
  },
  RANGER: {
    ...
    spawn: { speedPerTick: 350, selectionRadius, bodyRadius: 440, maxHealth: 110, attackDamage: 17, attackIntervalTicks: 14, attackRange: 10 * M },
  },
  SCOUT: {
    ...
    spawn: { speedPerTick: 550, selectionRadius: 600, bodyRadius: 380, maxHealth: 80, attackDamage: 8, attackIntervalTicks: 12, attackRange: 6 * M },
  },
  ELEMENTALIST: {
    ...
    spawn: { speedPerTick: 320, selectionRadius, bodyRadius: 420, maxHealth: 100, attackDamage: 14, attackIntervalTicks: 15, attackRange: 9 * M },
  },
  ENGINEER: {
    ...
    spawn: { speedPerTick: 330, selectionRadius, bodyRadius: 420, maxHealth: 120, attackDamage: 9, attackIntervalTicks: 15, attackRange: 1.25 * M },
  },
  GOLEM: {
    ...
    spawn: { speedPerTick: 230, selectionRadius: 900, bodyRadius: 600, maxHealth: 600, attackDamage: 42, attackIntervalTicks: 18, attackRange: 1.25 * M },
  },
  SIEGE_CONSTRUCT: {
    ...
    spawn: { speedPerTick: 180, selectionRadius: 900, bodyRadius: 650, maxHealth: 320, attackDamage: 25, attackIntervalTicks: 30, attackRange: 14 * M },
  },
};
