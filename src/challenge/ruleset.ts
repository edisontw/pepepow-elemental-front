 ...
 */
export const CURRENT_CHALLENGE_RULESET_VERSION = 'ef-standard-v19' as const;
...
export function isSupportedChallengeRuleset(version: string): boolean {
  // v12-v18 challenge links remain parseable as historical non-current runs.
  // v19 stabilizes same-target melee arrival traffic on top of v18 contact rings.
