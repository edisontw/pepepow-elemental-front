 ...
 */
export const CURRENT_CHALLENGE_RULESET_VERSION = 'ef-standard-v14' as const;
...
export function isSupportedChallengeRuleset(version: string): boolean {
  // v12/v13 challenge links remain playable for non-Tower Defense runs.
  // Tower Defense replay/score authority uses the current ruleset.
